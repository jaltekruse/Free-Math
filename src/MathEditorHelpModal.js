...
var MathEditorHelp = createReactClass({
    render() {
         ...
         *        produce latex for them
            <tr><td>\N <input type="submit" disabled="disabled" value="Enter"/></td>
                <td><span ref="exampleStaticMath8">\N</span></td></tr>
            <tr><td>\Z <input type="submit" disabled="disabled" value="Enter"/></td>
                <td><span ref="exampleStaticMath9">\Z</span></td></tr>
            <tr><td>\Q <input type="submit" disabled="disabled" value="Enter"/></td>
                <td><span ref="exampleStaticMath10">\Q</span></td></tr>
        */
        return (
        <div>
            ...
            <div style={{display:"inline-block"}}>
                <div style={{float:"left"}}>
                    ...
                    <thead>
                        <tr><th style={{textAlign:"left"}}>Type this...</th>
                            <th style={{textAlign:"left"}}>For Symbol&nbsp;&nbsp;&nbsp;</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr><td>/ (slash)</td>
                        ...
                        <tr><td>sqrt</td><td><span ref="exampleStaticMath6">
                                    {"\\sqrt{x}"}</span></td></tr>
                        <tr><td>\nthroot <input type="submit" disabled="disabled" value="Enter"/>
                        </td><td><span ref="exampleStaticMath5">{"\\sqrt[y]{x}"}</span></td></tr>
                        <tr><td>| (shift backslash)</td>
                            <td><span ref="exampleStaticMath7">{"|x|"}</span></td></tr>
                        <tr><td>&gt;=</td><td><TeX>\ge</TeX></td></tr>
                        <tr><td>&lt;=</td><td><TeX>\le</TeX></td></tr>
                        <tr><td>\approx <input type="submit" disabled="disabled" value="Enter"/>
                            </td>
                            <td><TeX>\approx</TeX></td></tr>
                        <tr><td>_ (underscore)</td>
                            <td><span ref="exampleStaticMath">a_b</span>  (subscript)</td></tr>
                        <tr><td>^</td>
                            <td><span ref="exampleStaticMath2">a^b</span> (power)</td></tr>
                        <tr><td>\pm <input type="submit" disabled="disabled" value="Enter"/></td>
                            <td><TeX>\pm</TeX></td></tr>
                        <tr><td>\degree <input type="submit" disabled="disabled" value="Enter"/>
                            </td>
                            <td><TeX>\degree</TeX></td></tr>
                        <tr><td>\angle <input type="submit" disabled="disabled" value="Enter"/></td>                            <td><TeX>\angle</TeX></td></tr>
                        <tr><td>int</td><td><TeX>\int</TeX></td></tr>
                        <tr><td>\oint <input type="submit" disabled="disabled" value="Enter"/>
                            </td>
                            <td><TeX>\oint</TeX></td></tr>
                        <tr><td>\partial <input type="submit" disabled="disabled" value="Enter"/>
                            </td>
                            <td><TeX>\partial</TeX></td></tr>
                ...
                <div style={{float:"left"}}>
                    ...
                    <tbody>
                        <tr><td>\infinity <input type="submit" disabled="disabled" value="Enter"/>
                            </td><td><TeX>\infty</TeX></td></tr>
                        ...
                        <tr><td>\in <input type="submit" disabled="disabled" value="Enter"/></td>
                            <td><TeX>\in</TeX></td></tr>
                        <tr><td>\to <input type="submit" disabled="disabled" value="Enter"/></td>
                            <td><TeX>\to</TeX></td></tr>
                        <tr><td>\gets <input type="submit" disabled="disabled" value="Enter"/>
                            </td><td><TeX>\gets</TeX></td></tr>
                        <tr><td>union</td><td><TeX>\cup</TeX></td></tr>
                        <tr><td>\intersect <input type="submit" disabled="disabled" value="Enter"/>
                            </td><td><TeX>\cap</TeX></td></tr>
                        <tr><td>subset</td><td><TeX>\subset</TeX></td></tr>
                        <tr><td>\subseteq <input type="submit" disabled="disabled" value="Enter"/>
                            </td>
                            <td><TeX>\subseteq</TeX></td></tr>
                        <tr><td>\superset <input type="submit" disabled="disabled" value="Enter"/>
                            </td>
                            <td><TeX>\supset</TeX></td></tr>
                        <tr><td>\superseteq <input type="submit" disabled="disabled" value="Enter"/>
                            </td>
                            <td><TeX>\supseteq</TeX></td></tr>
                    </tbody>
                    </table>
                </div>
                <div style={{float:"left"}}>
                    ...
                    <tbody>
                        ...
                        <tr><td>\Gamma <input type="submit" disabled="disabled" value="Enter"/>
                            </td><td><TeX>\Gamma</TeX></td></tr>
                        ...
                        <tr><td>\Delta <input type="submit" disabled="disabled" value="Enter"/></td>                            <td><TeX>\Delta</TeX></td></tr>
                            ...
                            <tr><td>\Theta <input type="submit" disabled="disabled" value="Enter"/>
                                </td><td><TeX>\Theta</TeX></td></tr>
                            <tr><td>iota</td><td><TeX>\iota</TeX></td></tr>
                            <tr><td>kappa</td><td><TeX>\kappa</TeX></td></tr>
                            <tr><td>lambda</td><td><TeX>\lambda</TeX></td></tr>
                            <tr><td>\Lambda <input type="submit" disabled="disabled" value="Enter"/>
                                </td>
                                <td><TeX>\Lambda</TeX></td></tr>
                            <tr><td>\mu <input type="submit" disabled="disabled" value="Enter"/>
                                </td>
                                <td><TeX>\mu</TeX></td></tr>
                            <tr><td>\nu <input type="submit" disabled="disabled" value="Enter"/>
                                </td><td><TeX>\nu</TeX></td></tr>
                        </tbody>
                        </table>
                    </div>
                    <div style={{float:"left"}}>
                        ...
                        <tbody>
                            ...
                            <tr><td>\Xi <input type="submit" disabled="disabled" value="Enter"/>
                                </td>
                                <td><TeX>\Xi</TeX></td></tr>
                            <tr><td>pi</td><td><TeX>\pi</TeX></td></tr>
                            <tr><td>\Pi <input type="submit" disabled="disabled" value="Enter"/>
                                </td>
                                <td><TeX>\Pi</TeX></td></tr>
                            <tr><td>rho</td><td><span ref="exampleStaticMath4">\rho</span></td></tr>
                            <tr><td>\varrho <input type="submit" disabled="disabled" value="Enter"/>
                                </td>
                                <td><TeX>\varrho</TeX></td></tr>
                            <tr><td>sigma</td><td><TeX>\sigma</TeX></td></tr>
                            <tr><td>\Sigma <input type="submit" disabled="disabled" value="Enter"/>
                                </td><td><TeX>\Sigma</TeX></td></tr>
                            <tr><td>tau</td><td><TeX>\tau</TeX></td></tr>
                            <tr><td>upsilon</td><td><TeX>\upsilon</TeX></td></tr>
                            <tr><td>\Upsilon 
                                    <input type="submit" disabled="disabled" value="Enter"/></td>
                                <td><TeX>\Upsilon</TeX></td></tr>
                            <tr><td>\phi
                                    <input type="submit" disabled="disabled" value="Enter"/></td>
                                <td><TeX>\phi</TeX></td></tr>
                            <tr><td>\Phi
                                    <input type="submit" disabled="disabled" value="Enter"/></td>
                                <td><TeX>\Phi</TeX></td></tr>
                            <tr><td>\chi
                                    <input type="submit" disabled="disabled" value="Enter"/></td>
                                <td><TeX>\chi</TeX></td></tr>
                            <tr><td>\psi
                                    <input type="submit" disabled="disabled" value="Enter"/></td>
                                <td><TeX>\psi</TeX></td></tr>
                            <tr><td>\Psi
                                    <input type="submit" disabled="disabled" value="Enter"/></td>
                                <td><TeX>\Psi</TeX></td></tr>
