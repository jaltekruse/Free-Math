    ...
    render: function() {
        ...
        return (
            <div className="problem-container" style={{float:'none',overflow: 'scroll'}}>
                ...
                <div>
                    <div>
                        Problem number <input type="text" value={probNumber}
                        onChange={function(evt) {
                            window.store.dispatch(
                                { type : SET_PROBLEM_NUMBER, PROBLEM_INDEX : problemIndex,
                                  NEW_PROBLEM_NUMBER : evt.target.value})
                        }}/> &nbsp;&nbsp;&nbsp;
                        <input type="submit" value="Clone Problem"
                               title={"Make a copy of this work, useful if you need " +
                                      "to reference it while trying another solution path."}
                               onClick={function() {
                                   window.store.dispatch(
                                       { type : CLONE_PROBLEM, PROBLEM_INDEX : problemIndex})
                               }}/>&nbsp;&nbsp;&nbsp;
                                       ...
                                       onChange={function(value) {
                                            window.store.dispatch(
                                                { type : EDIT_STEP, PROBLEM_INDEX : problemIndex,
                                                  STEP_KEY : stepIndex, NEW_STEP_CONTENT : value});
                                           }}
                                       onSubmit={function() {
                                            window.store.dispatch(
                                                { type : NEW_STEP, PROBLEM_INDEX : problemIndex});
